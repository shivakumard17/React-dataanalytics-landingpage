  ...
  return (
    <div className='text-white'>
      ...
      <div className='flex justify-center items-center'>
        ...
        <Typed 
                 className='md:text-5xl sm:text-4xl text-xl text-[#0e966b] font-bold md:pl-4 pl-2'
                strings={[
                    'BTB',
                    'BTC',
                    'SASS']}
      ...
      <button className='bg-[#00df9a] hover:bg-[#e7e7e7]  rounded-md font-medium  w-[200px] my-6  mx-auto py-3    text-black'>Get Started</button>
